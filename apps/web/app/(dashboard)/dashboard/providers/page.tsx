  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mt-2 max-w-md text-muted-foreground">
        Find and connect with trusted local service providers — plumbers, electricians, HVAC techs, and more — all vetted and reviewed.
      </p>
      ...
      <p className="mt-4 text-xs text-muted-foreground">Coming soon in Phase 3</p>
    </div>
  );
}
