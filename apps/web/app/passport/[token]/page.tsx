...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!passport || !passport.isPublic) {
    return { title: "Passport Not Found | HomeBase AI" };
  }

  if (passport.shareExpiresAt && new Date(passport.shareExpiresAt) < new Date()) {
    return { title: "Passport Expired | HomeBase AI" };
  }

  return {
    title: `${passport.home.name} - Home Passport | HomeBase AI`,
    description: `Digital home passport for ${passport.home.name}. Generated by HomeBase AI.`,
  };
}
